    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.CharField(choices=[('Bussiness', 'Bussiness'), ('IT', 'It'), ('Banking', 'Banking'), ('Education', 'Education'), ('Telecommunication', 'Telecommunication'), ('Others', 'Others')], default='Bussiness', max_length=20)),
                ('experience', models.CharField(choices=[('NO_EXPERIENCE', 'No Experience'), ('ONE_YEAR', 'One Year'), ('TWO_YEAR', 'Two Year'), ('THREE_YEAR_PLUS', 'Three Year Plus')], default='NO_EXPERIENCE', max_length=20)),
